...
public class RitualPoleBlockEntity extends BlockEntity {
    public static final HashMap<EntityType<?>, List<ItemStack>> ENTITY_TYPE_LOOT_MAP = new HashMap<>(Map.ofEntries(
            ...
            Map.entry(EntityType.LLAMA, List.of(new ItemStack(Items.LEATHER, 64))),
            Map.entry(EntityType.MAGMA_CUBE, List.of(new ItemStack(Items.MAGMA_CREAM, 32))),
            ...
            Map.entry(EntityType.PANDA, List.of(new ItemStack(Items.BAMBOO, 64), new ItemStack(Items.BAMBOO, 64))),
            Map.entry(EntityType.PARROT, List.of(new ItemStack(Items.FEATHER, 8))),
            Map.entry(EntityType.PHANTOM, List.of(new ItemStack(Items.PHANTOM_MEMBRANE, 32))),
            ...
            Map.entry(EntityType.PIGLIN_BRUTE, List.of(new ItemStack(Items.GOLD_INGOT, 64))),
            Map.entry(EntityType.PILLAGER, List.of(new ItemStack(Items.CROSSBOW, 1), new ItemStack(Items.ARROW, 64), new ItemStack(Items.EMERALD, 32))),
            Map.entry(EntityType.POLAR_BEAR, List.of(new ItemStack(Items.COOKED_COD, 64), new ItemStack(Items.COOKED_SALMON, 64))),
            Map.entry(EntityType.PUFFERFISH, List.of(new ItemStack(Items.PUFFERFISH, 32))),
            Map.entry(EntityType.RABBIT, List.of(new ItemStack(Items.COOKED_RABBIT, 24), new ItemStack(Items.RABBIT_HIDE, 12))),
            Map.entry(EntityType.RAVAGER, List.of(new ItemStack(Items.EMERALD, 64), new ItemStack(Items.EMERALD, 64))),
            Map.entry(EntityType.SALMON, List.of(new ItemStack(Items.COOKED_SALMON, 24))),
            Map.entry(EntityType.SHEEP, List.of(new ItemStack(Items.COOKED_MUTTON, 24), new ItemStack(Items.WHITE_WOOL, 24))),
            Map.entry(EntityType.SHULKER, List.of(new ItemStack(Items.SHULKER_SHELL, 32))),
            Map.entry(EntityType.SILVERFISH, List.of(new ItemStack(Items.INFESTED_STONE, 24))),
            Map.entry(EntityType.SKELETON, List.of(new ItemStack(Items.BOW, 1), new ItemStack(Items.ARROW, 64), new ItemStack(Items.BONE, 64))),
            Map.entry(EntityType.SKELETON_HORSE, List.of(new ItemStack(Items.BONE, 64), new ItemStack(Items.BONE, 64))),
            Map.entry(EntityType.SLIME, List.of(new ItemStack(Items.SLIME_BALL, 64))),
            Map.entry(EntityType.SNOW_GOLEM, List.of(new ItemStack(Items.SNOW_BLOCK, 64))),
            Map.entry(EntityType.SNIFFER, List.of(new ItemStack(Items.TORCHFLOWER, 64), new ItemStack(Items.PITCHER_PLANT, 64))),
            Map.entry(EntityType.SPIDER, List.of(new ItemStack(Items.STRING, 64))),
            Map.entry(EntityType.SQUID, List.of(new ItemStack(Items.INK_SAC, 64))),
//            Map.entry(EntityType.STRAY, List.of(new ItemStack(Items.TIPPED_ARROW, 32), new ItemStack(Items.BONE, 64))),
//            Map.entry(EntityType.STRIDER, List.of(new ItemStack(Items.ARROW_OF_SLOWNESS, 32), new ItemStack(Items.BONE, 64))),
